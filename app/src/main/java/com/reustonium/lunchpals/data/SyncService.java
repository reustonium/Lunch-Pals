...
import com.reustonium.lunchpals.util.AndroidComponentUtil;
import com.reustonium.lunchpals.util.NetworkUtil;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        LunchPalsApplication.get(this).getComponent().inject(this);
    }
